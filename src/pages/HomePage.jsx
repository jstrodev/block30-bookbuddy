          ...
          <div>
            <div className="mainTitle">
              ...
              <div className = "signinLogin">
                <Link to="/AuthPage"><button type="button" className="btn btn-outline-primary">Sign Up</button></Link>&nbsp;&nbsp;
                <Link to="/AuthPage"><button type="button" className="btn btn-outline-success">Log In</button></Link>
              </div>
            </div>
